define(function(require) {
	...
	AJAXMY.send('/article/list',{category_code:articletype,page:1,size:30},function(data){
		...
		$.each(dr,function(key,value){
			...
			articleHtml+='<div class="dynamicblock"><img src="'+value['coverPic']+'"><div class="dynamiclayer displaytable"><div><p class="mainstrong">'+value['title']+'</p><p class="dynamicsummary">'+value['summary']+'</p><p><span>文/'+value['authorName']+'</span><a href="article_details.html?id='+value['id']+'"><span>查看详情</span></a></p></div></div></div>';
		});
